...
def login():
   ...
   # browser = webdriver.Firefox()
    ...
    browser.find_element_by_id("j_username").send_keys("guozhiquan")
    browser.find_element_by_name("j_password").clear()
    browser.find_element_by_name("j_password").send_keys("123456")
...
def click_job(jobViewName):
    ...
    #browser.find_element_by_link_text("开发环境3.0").click()
    # 获取网页内容
